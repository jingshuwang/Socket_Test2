    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                // emissive = emissive + _MaskTex_var.xyz;
                float mask_value = _MaskTex_var.x;
                float4 finalColor = fixed4(emissive, node_1857);
                finalColor = mask_value * _Emission + (1 - mask_value) * finalColor;
                return finalColor;
            }
            ENDCG
        }
